...
#that didnt work, dont know where the rest of this script went
#tbh I think I just plotted the above values to form a line plot 
#withquality along X axis and quantity along y-axis